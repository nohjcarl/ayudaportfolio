...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>Jhon Carl J. Ayuda</a>.</span><br><br>I am a Information Technology student at <span class='bold'>Holy Cross of Davao College 👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities  <span class='bold'>If you want to view my portfolio Just click my photo.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":    
            sendTextMessage("<span class='sk'>Send Keyword to get what you want to know about me...<br>e.g<br><span class='bold'>'skills'</span> - to know my skills<br><span class='bold'>'education'</span> - to get my education details<br><span class='bold'>'clear'</span> - to clear conversation<br><span class='bold'>'about'</span> - to know about this site</span>");
            break;
        
            
        case "skills":
            sendTextMessage("<span class='sk'>I am currently pursuing Bachelor in Science in Information Technology.<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C++<br>CSS<br>HTML</span><br><br>I've experiance with following frameworks :<span class='bold'><br>Django<br>ReactJs");
            break;

        case "education":
            sendTextMessage("I am currently pusuing Bachelor Of Science in Information Technology at Holy Cross of Davao College<br>Started OCT : 2023 to Present : 2025<br><br>");
            break;
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by <a class='alink' target='_blank' href='https://www.instagram.com/jcnohjlrac/'><span class='bold'>Jhon Carl J Ayuda</a> with ❤️</span>");
            break;
        case "contact":
